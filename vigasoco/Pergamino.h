...
public:
	...
	// TODO no esta definido el caracter 5 en el pergamino y no podemos , por ejemplo,
...
//	static const unsigned char *pergaminoAyudasyMejoras[8];	// texto del pergamino del final del juego
	...
	int posX, posY;			// posición inicial del texto en el pergamino
	UINT16 *charTable;		// puntero a la tabla de punteros a los gráficos de los caracteres
