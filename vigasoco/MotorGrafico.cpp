...
// comprueba si el personaje al que sigue la cámara ha cambiado de pantalla 
// y si es así, actualiza las variables del motor
...
{
	// recorre los personajes, y para los visibles,
	// actualiza su posición y animación y marca la altura que ocupan
